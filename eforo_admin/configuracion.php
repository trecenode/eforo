...
<input type="radio" name="c_codigo" value="1"<?php if($conf['permitir_codigo']) echo ' checked' ; ?>>S�
</td>
</tr>
<tr>
...
<input type="radio" name="c_caretos" value="1"<?php if($conf['permitir_caretos']) echo ' checked' ; ?>>S�
</td>
</tr>
<tr>
...
<input type="radio" name="c_firma" value="1"<?php if($conf['permitir_firma']) echo ' checked' ; ?>>S�
</td>
</tr>
<tr>
...
<input type="radio" name="c_censurar" value="1"<?php if($conf['censurar_palabras']) echo ' checked' ; ?>>S�
</td>
</tr>
<tr>
...
<input type="radio" name="c_notificacion" value="1"<?php if($conf['notificacion_email']) echo ' checked' ; ?>>S�
</td>
</tr>
<tr>
